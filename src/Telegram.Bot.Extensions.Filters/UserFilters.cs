...
namespace Telegram.Bot.Extensions.Filters
{
    ...
    public static class UserFilters
    {
        ...
        /// <returns>A <see cref="Filter{T}"/> that checks for a user's IETF language code.</returns>
